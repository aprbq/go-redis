...
| Cache at Repository | Repository — cache ผล query จาก DB | ~2,400 |
| Cache at Service | Service — cache ผลหลังผ่าน business logic | ~2,600 |
| Cache at Handler | Handler — cache JSON response ทั้งก้อน | ~3,000 |
